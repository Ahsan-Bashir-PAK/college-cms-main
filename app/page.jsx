              ...
              <div className='border  w-11/12 h-full m-auto flex fex-row'>
                ...
                {/* Header Area */}
                 <div className='w-9/12 h-full'>
                    ...
                    <div className='  justify-center items-center   w-full  flex flex-row mb-1 h-1/6'>
                        <div className=" text-white flex justify-center items-center align-middle bg-gradient-to-tr from-blue-900 to-blue-300 p-2 flex-col  m-2  w-3/12 rounded-lg shadow-md shadow-black">
                          <h1>Total Pass Out Trainees </h1>
                          <h5>5000</h5>
                          
                          
                          </div>
                        <div className="bg-gradient-to-tr from-blue-800 to-blue-300 p-6 m-2 w-3/12  rounded-lg">dsfd</div>
                        <div className="bg-gradient-to-tr from-blue-800 to-blue-300 p-6 m-2 w-3/12  rounded-lg">dsfd</div>

                    </div> {/*end of Header Area*/}
                    
                    <div className=' border border-black justify-center items-center  bg-slate-900 w-full  flex flex-row mb-1 h-8 text-white'>
                        <h1>Present Undergoing Courses</h1>

                    </div>

                    {/* Container Area */}
                    <div className=' w-full h-full  border border-black bg-blue-200 flex'>
