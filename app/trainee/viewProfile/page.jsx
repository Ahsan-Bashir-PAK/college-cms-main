...
const AccountVerf = ()=>{
        ...
        let cnic = searchParams.get("cn");
        
        useEffect(()=>{
                 console.log(`http://localhost:5000/users/getuser?id=${cnic}`)
                                ...
                                <table className='w-full  p-2'>
                                       ...
                                       <tr  className='border border-black p-2'>
                                        ...
                                        <tr  className='border border-black p-2'>
                                                ...
                                                <td className='border p-2 border-black w-80'>Upper Class Course</td>
                                        </tr>
                                        <tr  className='border border-black p-2'>
                                                <td className='border p-2 border-black w-60'>Date Of Appointment</td>
                                                <td className='border p-2 border-black w-80'>07-01-2002</td>
                                        ...
                                        <tr  className='border border-black p-2'>
                                                ...
                                                <td className='border p-2 border-black w-80'>Nil</td>
                                                <td className='border p-2 border-black w-60'>Date of Arrival in College</td>
                                                <td className='border p-2 border-black w-80'>05-05-2024</td>
                                        </tr>
